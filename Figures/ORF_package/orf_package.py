...
#ET from LAL
u_ET1 = np.array([-0.70045821479, 0.20848948619, 0.68256166277])
v_ET1 = np.array([-0.39681482542, -0.73500471881, 0.54982366052])
L_ET1 = 10000
x_ET1 = np.array([4.54637409900e6, 8.42989697626e5, 4.37857696241e6])

u_ET2 = np.array([0.30364338937, -0.94349420500, -0.13273800225])
v_ET2 = np.array([0.70045821479, -0.20848948619, -0.68256166277])
L_ET2 = 10000
x_ET2 = np.array([4.53936951685e6, 8.45074592488e5, 4.38540257904e6])

u_ET3 = np.array([0.39681482542, 0.73500471881, -0.54982366052])
v_ET3 = np.array([-0.30364338937, 0.94349420500, 0.13273800225])
L_ET3 = 10000
x_ET3 = np.array([4.54240595075e6, 8.35639650438e5, 4.38407519902e6])
